...
- $f(1) = 2$
- $f(0) = -1$
- $f(2) = \frac{f(1)}{f(0)} = \frac{2}{-1} = -2$
- $f(3) = \frac{f(2)}{f(1)} = \frac{-2}{2} = -1$
- $f(4) = \frac{f(3)}{f(2)} = \frac{-1}{-2} = \frac{1}{2}$
- $f(5) = \frac{f(4)}{f(3)} = \frac{\frac{1}{2}}{-1} = -\frac{1}{2}$

---

|  $n$   |  $0$  |  $1$  |  $2$  |  $3$  |      $4$      |      $5$       |
| :----: | :---: | :---: | :---: | :---: | :-----------: | :------------: |
| $f(n)$ | $-1$  |  $2$  | $-2$  | $-1$  | $\frac{1}{2}$ | $-\frac{1}{2}$ |
